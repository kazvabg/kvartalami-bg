...
export const SITE = {
  ...
  description: 'Ежедневен преглед на новините за район Оборище в София — ремонти, водни и топлинни аварии, решения на местната власт и събития. Автоматично събиране от Софийска вода, Топлофикация, Столична община и Район Оборище.',
